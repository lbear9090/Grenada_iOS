...
class GCGGrenadaVC: UIViewController, UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout, UIScrollViewDelegate {
    ...
    let itemSize = 80
    let categories = [CategoryInfo(img:"act", name:"act", text:"Act text", isText:false, pagetype:0),
                      CategoryInfo(img:"bar", name:"bar", text:"bar text", isText:false, pagetype:1),
                      CategoryInfo(img:"bus", name:"bus", text:"bus text", isText:false, pagetype:0),
                      CategoryInfo(img:"beach", name:"beach", text:"beach text", isText:false, pagetype:0),
                      CategoryInfo(img:"food", name:"food", text:"food text", isText:false, pagetype:1),
                      CategoryInfo(img:"fun", name:"fun", text:"fun text", isText:false, pagetype:0),
                      CategoryInfo(img:"hotel", name:"hotel", text:"hotel text", isText:false, pagetype:1),
                      CategoryInfo(img:"rental",name:"rental", text:"rental text", isText:false, pagetype:0),
                      CategoryInfo(img:"shop", name:"shop", text:"shop text", isText:false, pagetype:1),
                      CategoryInfo(img:"yacht", name:"yacht", text:"yacht text", isText:false, pagetype:0),
                      CategoryInfo(img:"carr", name:"C", text:"C text", isText:true, pagetype:1),
                      CategoryInfo(img:"pmart", name:"PM", text:"PM text", isText:true, pagetype:0),
                      ]
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        if(categories[indexPath.row].pagetype == 0){
            let vc = self.storyboard?.instantiateViewController(withIdentifier: "PageFirstVC")
            self.navigationController?.pushViewController(vc!, animated: true)
        }else{
            let vc = self.storyboard?.instantiateViewController(withIdentifier: "PageSecondVC")
            self.navigationController?.pushViewController(vc!, animated: true)
        }
    }
